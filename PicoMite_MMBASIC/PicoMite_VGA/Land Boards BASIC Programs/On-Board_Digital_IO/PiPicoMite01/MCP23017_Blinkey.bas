...
Pause 500
I2C2 WRITE MCP23017_I2CADR, 0, 2, MCP23017_OLATA, 1
Pause 500
If Inkey$ <> "" GoTo Done
GoTo loopBack
...
Sub initMCP23017()
  'Set all pins to inputs except PORTA Bit 0
  I2C2 WRITE MCP23017_I2CADR, 0, 2, MCP23017_IODIRA, &HFE
