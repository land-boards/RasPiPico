...
// QVGA includes
#include "_qvga/mat2d.h"	// 2D transformation matrix
#include "_qvga/draw.h"		// draw
#include "_qvga/rand.h"		// random number generator
#include "_qvga/pwmsnd.h"	// PWM sound output
#include "_qvga/qvga.h"		// QVGA core
