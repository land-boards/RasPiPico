...
Initial aim was to get the [EtchedPixels](https://github.com/EtchedPixels/RC2014 Linux based Z80 emulation) including an SD Card based IDE running on a Pi Pico as a standalone.
