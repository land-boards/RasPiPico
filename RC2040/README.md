# RC2040 - Z80 emulation of RC2014 using the RP2040 processor
...
Initial aim was to get the [EtchedPixels Linux based Z80 emulation](https://github.com/EtchedPixels/RC2014) including an SD Card based IDE running on a Pi Pico as a standalone.
